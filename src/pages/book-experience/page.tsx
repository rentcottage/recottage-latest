  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title={
          active
            ? t('experience.seo.titleActive', { title: active.title })
            : t('experience.seo.title')
        }
        description={active?.description ?? t('experience.seo.description')}
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-16">
        {loading ? (
          <div className="text-center py-16 text-gray-400 text-sm">{t('experience.loading')}</div>
                ...
                <div className="rounded-card overflow-hidden border border-line shadow-card">
                    ...
                    {photos.length > 1 && (
                      <>
                        <button
                          ...
                          aria-label={t('experience.gallery.prevPhoto')}
                        ...
                        <button
                          ...
                          aria-label={t('experience.gallery.nextPhoto')}
                    ...
                    <div className="flex gap-2 px-3 py-3 overflow-x-auto bg-gray-50 border-b border-gray-100">
                      {photos.map((url, i) => (
                        <button
                          ...
                          aria-label={t('experience.gallery.photoN', { number: i + 1 })}
                        >
                  ...
                  <div className="p-4 md:p-6">
                    ...
                    <div className="border-t border-line pt-3 md:pt-5 flex items-baseline gap-2">
                      <span className="text-xs text-gray-400">{t('home.experiences.from')}</span>
                      ...
                      <span className="text-xs text-gray-400">{t('home.experiences.perPerson')}</span>
                    </div>
                  </div>
                </div>
              )}
